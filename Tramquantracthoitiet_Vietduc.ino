...
#define BLYNK_TEMPLATE_ID           "TRAMQUANTRAC"
#define BLYNK_TEMPLATE_NAME         "TRAMQUANTRAC"
...
#define TIME_BUZZER_WARNING     300 
...
#define RAIN_ON   0
#define RAIN_OFF  1
int rainCountPulse = 0;                      
int  R_Funnel = 0;                           
int  V_AmountOfWater = 0 ;                   
int  S_Funnel = 0 ;                          
float onePulseValue = 0;                     
...
float D_Anemometer = 0;      
#define PI  3.14
float C_Anemometer = 0;     
float windValue = 0;
